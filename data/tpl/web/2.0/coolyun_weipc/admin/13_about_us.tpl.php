                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="col-lg-10">
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">页面banner</label></div>
                                    ...
                                    <div class="row form-group">
										...
										<?php  echo tpl_ueditor('info', $setting['info']);?> 
										</div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">联系链接</label></div>
										<div class="col-12 col-md-6"><input type="text" name="url" value="<?php  echo $setting['url'];?>" class="form-control"></div>
                                    </div>
