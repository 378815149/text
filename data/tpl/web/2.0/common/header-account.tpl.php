...
<div class="account-info">
	...
	<div class="account-type">
		...
		<span class="account-isconnect">
			...
			未接入
			<a href="<?php  echo url('account/post', array('uniacid' => $_W['account']['uniacid']))?>" class="text-danger"> 立即接入</a>
			<?php  } else { ?>
			已接入
			<?php  } ?>
		</span>
	...
	<div class="account-operate">
		...
		<a href="<?php  echo url('account/post', array('uniacid' => $_W['account']['uniacid'], 'account_type' => $_W['account']['type']))?>" class="h">管理设置</a>
		<?php  } ?>
	</div>
