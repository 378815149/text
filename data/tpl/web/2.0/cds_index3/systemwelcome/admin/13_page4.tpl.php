...
<ul class="we7-page-tab">
	<li <?php  if($op=='list') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('page4',array('op'=>'list'))?>">列表</a></li>
	<li <?php  if($op=='modify') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('page4',array('op'=>'modify'))?>">添加</a></li>
</ul>
<?php  if($op == 'list') { ?>
